    ...
    POTENZA.mailchimp = function () {
        $(document).on("click", "#mc-embedded-subscribe", function (event) {
            ...
            if (email_id != "" && val_email_id === true) {
                ...
                $("#msg").html(
                    '<p style="color: #EA4335">Enter the E-mail id</p>'
                );
                return false;
            }
            return false;
...
****************************************************/
    POTENZA.pieChart = function () {
        if ($pieChart.exists()) {
            loadScript(
                plugin_path + "easy-pie-chart/easy-pie-chart.js",
                function () {
        ...
        if ($("#datatable").exists()) {
            loadScript(
                ...
                function () {
                    loadScript(
                        plugin_path +
                            "bootstrap-datatables/dataTables.bootstrap4.min.js",
                        function () {
                            $("#datatable").DataTable();
                        }
                    );
...
*************************/
    ...
    POTENZA.colorpicker = function () {
        if (
            $(
                "#cp1, #cp2, #cp3, #cp4, #cp5, #cp6, #cp17, #cp8, #cp9, #cp10, #cp11, #cp12, #cp13"
            ).exists()
        ) {
            $("#cp1").colorpicker();
...
*************************/
    ...
    POTENZA.ptTouchSpin = function () {
        if ($("input.touchspin-input").exists()) {
            ...
            $(
                "input[name='demo3_21'].touchspin-input,input[name='demo3_22'].touchspin-input"
            ).TouchSpin({
                initval: 40,
            });
...
*************************/
    ...
    POTENZA.editormarkdown = function () {
        if (
            $(
                "#editor-markdown-01, #editor-markdown-02, #editor-markdown-03"
            ).exists()
        ) {
            new SimpleMDE({
...
*************************/
    ...
    POTENZA.wizardform = function () {
        if (
            $(
                "#example-form, #example-basic, #example-manipulation, #example-vertical"
            ).exists()
        ) {
...
*************************/
    ...
    POTENZA.navactivation = function () {
        ...
        $(".side-menu-fixed .navbar-nav li.active")
            .parents("li")
            .addClass("active");
    };
...
****************************************************/
    ...
    $window.on("load", function () {
        POTENZA.preloader(), POTENZA.pieChart();
    });
