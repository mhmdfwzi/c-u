<nav class="navbar bg-white navbar-light sticky-top px-3 px-lg-5 my-2">
    <section class="navbar-left">
        <a href="<?php echo e(route('home')); ?>" class="navbar-brand">
            <img class="img-fluid" height="50" width="150" src="<?php echo e(asset('frontend/img/logo_1.png')); ?>" alt="">
    ...
    <section class="navbar-center mt-3">
        ...
        <div class="menu" id="menu">
            ...
            <ul class="menu-inner p-0 ">
                ...
                <li class="menu-item menu-dropdown">
                    ...
                    <div class="submenu megamenu megamenu-column-4">
                        ...
                        <?php $__currentLoopData = $products->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="submenu-inner">
                                <a href="<?php echo e(route('serviceProductDetails', $product->id)); ?>"
                                    class="submenu-link-1 mb-2">
                                    <img src="<?php echo e($product->image_url); ?>" style="min-height: 200px; max-height:200px"
                                        class="h-100 w-100  submenu-image" alt="Product">
                                    <span class="submenu-title"><?php echo e($product->title); ?></span>
                                </a>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <div class="m-auto">
                ...
                <li class="menu-item">
                    <a href="<?php echo e(route('blogsNews', 'blog')); ?>" class="menu-link" >المدونة</a>
                </li>

                <li class="menu-item">
                    <a href="<?php echo e(route('blogsNews', 'news')); ?>" class="menu-link" >الأخبار</a>
                </li>
...
<?php /**PATH /home/sites/37b/f/f4c6554c5f/httpdocs/resources/views/frontend/layouts/nav.blade.php ENDPATH**/ ?>