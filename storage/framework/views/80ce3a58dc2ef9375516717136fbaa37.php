...
<?php $__env->startSection('page-header'); ?>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">أضافة مدونة / أخبار</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">لوحة التحكم</a></li>
                    <li class="breadcrumb-item active">أضافة مدونة / أخبار</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="<?php echo e(Route('admin.blogsNews.store')); ?>"
                        autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <button type="submit" class="btn btn-success btn-md nextBtn btn-lg ">أضافة مدونة / أخبار</button>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/37b/f/f4c6554c5f/httpdocs/resources/views/backend/pages/blogsNews/create.blade.php ENDPATH**/ ?>