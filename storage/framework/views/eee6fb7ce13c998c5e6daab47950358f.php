<div class="container-fluid">
    <div class="row">
        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.dashboard')); ?>"><i class="ti-menu-alt"></i><span
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users-show')): ?>
                        <li>
                            ...
                            <ul id="users" class="collapse" data-parent="#sidebarnav">
                                <li> <a href="<?php echo e(route('admin.users.create')); ?>">أضافة مستخدم</a> </li>
                                <li> <a href="<?php echo e(route('admin.users.index')); ?>">كل المستخدمين</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="teamwork" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.teamwork.create')); ?>">أضافة فريق العمل</a> </li>
                            <li> <a href="<?php echo e(route('admin.teamwork.index')); ?>">كل فريق العمل</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="clients" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.clients.create')); ?>">أضافة عميل</a> </li>
                            <li> <a href="<?php echo e(route('admin.clients.index')); ?>">كل العملاء</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="pages" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.pages.create')); ?>">أضافة صفحة</a> </li>
                            <li> <a href="<?php echo e(route('admin.pages.index')); ?>">كل الصفحات</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="gallery" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.gallery.create')); ?>"> Add Gallery</a> </li>
                            <li> <a href="<?php echo e(route('admin.gallery.index')); ?>"> All Gallery </a> </li>
                    ...
                    <li>
                        ...
                        <ul id="images" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.images.create')); ?>"> أضافة صورة</a> </li>
                            <li> <a href="<?php echo e(route('admin.images.index')); ?>"> كل الصور </a> </li>
                    ...
                    <li>
                        ...
                        <ul id="portfolio" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.portfolio.create')); ?>">Add Portfolio</a> </li>
                            <li> <a href="<?php echo e(route('admin.portfolio.index')); ?>">All Portfolio</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="services" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.servicesProducts.create')); ?>">أضافة خدمة / منتج</a> </li>
                            <li> <a href="<?php echo e(route('admin.servicesProducts.index')); ?>">كل الخدمات / المنتجات</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="blogs" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.blogsNews.create')); ?>">أضافة مدونة / خبر</a> </li>
                            <li> <a href="<?php echo e(route('admin.blogsNews.index')); ?>">كل المدونات / الأخبار</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="seoData" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="<?php echo e(route('admin.seo.index')); ?>">All Seo Data</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="websiteInfo" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.websiteInfo.create')); ?>">أضافة معلومة</a> </li>
                            <li> <a href="<?php echo e(route('admin.websiteInfo.index')); ?>">كل معلومات الموقع</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="orders" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="<?php echo e(route('admin.orders.index')); ?>">كل الطلبات</a> </li>
        ...
        <!--=================================
<?php /**PATH /home/sites/37b/f/f4c6554c5f/httpdocs/resources/views/backend/layouts/main-sidebar.blade.php ENDPATH**/ ?>