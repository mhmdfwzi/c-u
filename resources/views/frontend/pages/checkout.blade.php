        ...
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-4">
                @if ($serviceProduct->type == 'product')
                    طلب المنتج
                @elseif ($serviceProduct->type == 'service')
                    طلب الخدمة
                @endif
    ...
    <div class='container'>
        <div class='window'>
            <div class='order-info py-5 '>
                ...
                <form method="post" enctype="multipart/form-data" action="{{ route('checkout') }}" autocomplete="off">

                    @csrf
                    <input type="hidden" name="service_product_id" value="{{ $serviceProduct->id }}">
            ...
            <div class='credit-info'>
                <div class='credit-info-content'>
                    ...
                    <div class="row desc mt-3 align-items-center">
                        <div class="col-md-4">
                            <img src="{{ $serviceProduct->image_url }}" class="full-width px-2" style="border-radius: 50%;"
                                alt="">
                        </div>
                        <div class="col-md-8">
                            <div>
                                <span
                                    style="font-weight: bold; font-size:16px; color:#f2881f">{{ $serviceProduct->title }}</span>
                            </div>
