<div class="container-xxl shape-section pt-5">
    ...
    <div class="row align-items-center ">
        <div class="col-lg-7 col-md-7 wow fadeInUp" data-wow-delay="0.1s">
           ...
           <li>-  <a href="https://international-elevators.com/storage/portfolio/profile.pdf" target="_blank" alt="WhatsApp">
               <img src="{{ asset('frontend/img/downloads.png') }}" height="35" width="35" alt="WhatsApp"> Download Profile
            </a></li>
            </ul>
        ...
        <div class="col-lg-5 col-md-5 wow fadeInUp" data-wow-delay="0.1s" style="position: relative">
         ...
         <img   width="350" src="https://international-elevators.com/frontend/img/4f09f752-19c8-4c03-a7d0-04ea3e942493.jpg" alt="">
