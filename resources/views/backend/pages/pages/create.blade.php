            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ Route('admin.pages.store') }}"
                        ...
                        <button type="submit" class="btn btn-success btn-md nextBtn btn-lg ">أضافة صفحة</button>
